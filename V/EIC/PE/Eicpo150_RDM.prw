...
#DEFINE LITERAL_PEDIDO             IF( nIdioma == INGLES, "PURCHASE ORDER NR: ", "NR. PEDIDO: " ) //"NR. PEDIDO: " - STR0001
#DEFINE LITERAL_ALTERACAO          IF( nIdioma == INGLES, "REVISION Number: "  , "Alteracao Numero: " ) //"ALTERAÃ+O N·mero: " - STR0002
#DEFINE LITERAL_DATA               IF( nIdioma == INGLES, "Date: "             , "Data: " ) //"Data: " - STR0003
#DEFINE LITERAL_PAGINA             IF( nIdioma == INGLES, "Page: "             , "Pagina: " ) //"Pßgina: " - STR0004
#DEFINE LITERAL_FORNECEDOR         IF( nIdioma == INGLES, "SUPPLIER........: " , "FORNECEDOR......: " ) //"FORNECEDOR......: " - STR0005
#DEFINE LITERAL_ENDERECO           IF( nIdioma == INGLES, "ADDRESS.........: " , "ENDERECO........: " ) //"ENDEREÃO........: " - STR0006
#DEFINE LITERAL_REPRESENTANTE      IF( nIdioma == INGLES, "REPRESENTATIVE..: " , "REPRESENTANTE...: " ) //"REPRESENTANTE...: " - STR0007
#DEFINE LITERAL_REPR_TEL           IF( nIdioma == INGLES, "TEL.: "             , "FONE: " ) //"FONE: " - STR0008
#DEFINE LITERAL_COMISSAO           IF( nIdioma == INGLES, "COMMISSION......: " , "COMISSAO........: " ) //"COMISS+O........: " - STR0009
#DEFINE LITERAL_CONTATO            IF( nIdioma == INGLES, "CONTACT.........: " , "CONTATO.........: " ) //"CONTATO.........: " - STR0010
#DEFINE LITERAL_IMPORTADOR         IF( nIdioma == INGLES, "IMPORTER........: " , "IMPORTADOR......: " ) //"IMPORTADOR......: " - STR0011
#DEFINE LITERAL_CONDICAO_PAGAMENTO IF( nIdioma == INGLES, "TERMS OF PAYMENT: " , "COND. PAGAMENTO.: " ) //"COND. PAGAMENTO.: " - STR0012
#DEFINE LITERAL_VIA_TRANSPORTE     IF( nIdioma == INGLES, "MODE OF DELIVERY: " , "VIA TRANSPORTE..: " ) //"VIA TRANSPORTE..: " - STR0013
#DEFINE LITERAL_DESTINO            IF( nIdioma == INGLES, "DESTINATION.....: " , "DESTINO.........: " ) //"DESTINO.........: " - STR0014
#DEFINE LITERAL_AGENTE             IF( nIdioma == INGLES, "FORWARDER.......: " , "AGENTE..........: " ) //"AGENTE..........: " - STR0015
#DEFINE LITERAL_QUANTIDADE         IF( nIdioma == INGLES, "Quantity"           , "Quantidade" ) //"Quantidade" - STR0016
#DEFINE LITERAL_DESCRICAO          IF( nIdioma == INGLES, "Description"        , "Descricao" ) //"DescriþÒo" - STR0017
#DEFINE LITERAL_FABRICANTE         IF( nIdioma == INGLES, "Manufacturer"       , "Fabricante" ) //"Fabricante" - STR0018
#DEFINE LITERAL_PRECO_UNITARIO1    IF( nIdioma == INGLES, "Unit"               , "Preco" ) //"Preþo" - STR0019
#DEFINE LITERAL_PRECO_UNITARIO2    IF( nIdioma == INGLES, "Price"              , "Unitario" ) //"Unitßrio" - STR0020
#DEFINE LITERAL_TOTAL_MOEDA        IF( nIdioma == INGLES, "Amount"             , "   Total" ) //"   Total" - STR0021
#DEFINE LITERAL_DATA_PREVISTA1     IF( nIdioma == INGLES, "Req. Ship"          , "Data Prev." ) //"Data Prev." - STR0022
#DEFINE LITERAL_DATA_PREVISTA2     IF( nIdioma == INGLES, "Date"               , "Embarque" ) //"Embarque" - STR0023
#DEFINE LITERAL_OBSERVACOES        IF( nIdioma == INGLES, "REMARKS"            , "OBSERVACOES" ) //"OBSERVAÃiES" - STR0024
#DEFINE LITERAL_INLAND_CHARGES     IF( nIdioma == INGLES, "INLAND CHARGES"     , "Despesas Internas" ) //"Despesas Internas" - STR0025
#DEFINE LITERAL_PACKING_CHARGES    IF( nIdioma == INGLES, "PACKING CHARGES"    , "Despesas Embalagem" ) //"Despesas Embalagem" - STR0026
#DEFINE LITERAL_INTL_FREIGHT       IF( nIdioma == INGLES, "INT'L FREIGHT"      , "Frete Internacional" ) //"Frete Internacional" - STR0027
#DEFINE LITERAL_DISCOUNT           IF( nIdioma == INGLES, "DISCOUNT"           , "Desconto" ) //"Desconto" - STR0028
#DEFINE LITERAL_OTHER_EXPEN        IF( nIdioma == INGLES, "OTHER EXPEN."       , "Outras Despesas" ) //"Outras Despesas" - STR0045
#DEFINE LITERAL_STORE              IF( nIdioma == INGLES, "STORE: "            , "Loja" ) //FDR - 06/01/12 //"Loja" - STR0046
...
cCadastro := "Seleção de Purchase Order" //"Seleção de Purchase Order" - STR0032
nPagina:=0
...
Local aRotAdic := {}   
Local aRotina :=  { { "Pesquisar","AxPesqui"  , 0 , 1},; //"Pesquisar" - STR0029
                    { "Emissao","Eval(bFuncao)", 0 , 0}} //"Emissao"###"ReEmissao" - SRT0030
...
@ (9*DLG_CHARPIX_H),(10*DLG_CHARPIX_W) TO (17*DLG_CHARPIX_H),(45*DLG_CHARPIX_W) DIALOG oDlgIdioma TITLE AnsiToOem("Seleção") //"Seleção" - STR0033

@  8,10 TO 48,80 TITLE "Selecione o Idioma" //"Selecione o Idioma" - STR0034
...
oRadio1 := oSend( TRadMenu(), "New", 17, 13, {"Inglês","Idioma Corrente"},{|u| If(PCount() == 0, nIdioma, nIdioma := u)}, oDlgIdioma,,,,,, .F.,, 55, 13,, .F., .T., .T. ) //"Inglês"###"Idioma Corrente" - STR0035 - STR0036
...
IF nMarcados == 0
   MsgInfo("Nao existem registros marcados para a impressao !","Atencao") //"NÒo existem registros marcados para a impressÒo !"###"AtenþÒo" - STR0037 - STR0038

ELSE
   dbSelectArea("SW2")

   AVPRINT oPrn NAME "Emissao do Pedido" //"EmissÒo do Pedido" - STR0039
...
&& INICIO
&& Borin - Totvs IP - 04/03/16
&& Alterado para pegar o nome do fornecedor e não o fantasia
oSend( oPrn, "Say",  Linha, 630, SA2->A2_NOME + Space(2) + Alltrim(IF(EICLOJA(), LITERAL_STORE /*"Loja:"*/ + Alltrim(SA2->A2_LOJA),"")) , aFontes:TIMES_NEW_ROMAN_12 ) //FDR - 06/01/12
...
oSend( oPrn, "Say",  Linha, 100 , "PROFORMA INVOICE: ", aFontes:COURIER_12_NEGRITO ) //"PROFORMA INVOICE: " - STR0040
...
oSend( oPrn, "Say",  Linha, 100, "INCOTERMS.......: "  , aFontes:COURIER_12_NEGRITO ) //"INCOTERMS.......: " - STR0041
...
oSend( oPrn, "Say",  Linha,  065, "IT"                , aFontes:TIMES_NEW_ROMAN_10_NEGRITO ) //"IT" STR0042
...
&& INICIO
&& Borin - Totvs IP - 04/03/2016
&& Comentado para não sair o fabricante na impressão
...
oSend( oPrn, "Say",  Linha,   65, "Nb"                , aFontes:TIMES_NEW_ROMAN_10_NEGRITO ) //"Nb" - STR0043
...
oSend( oPrn, "Say",  Linha,1570, "TOTAL ", aFontes:COURIER_08_NEGRITO ) //"TOTAL " //DFS - 28/02/11 - Posicionamento correto - STR0044
nTLinha := Linha 
...
oSend( oPrn, "Say",  Linha, 1570 , "TOTAL " + ALLTRIM( SW2->W2_INCOTER )         , aFontes:COURIER_08_NEGRITO ) //"TOTAL " - STR0044
