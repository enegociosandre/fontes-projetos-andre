...
/*/
//--------------------------------------------------------------------
User Function UPDINV( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDINV" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDINV" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX6, { ;
	...
	'ZZ_ACOMINV'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Texto a ser impresso no local da assinatura da'						, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'Commercial Invoice.'													, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'Vermeer Manufacturing Company'											, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
	''																		, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Campo para informação de outros' )
aAdd( aHlpPor, 'valores.' )

PutHelp( "PW6_ZZOTHER", aHlpPor, {}, {}, .T. )
AutoGrLog( "Atualizado o Help do campo " + "W6_ZZOTHER" )
