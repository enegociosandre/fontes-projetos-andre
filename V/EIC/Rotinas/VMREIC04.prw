...
Nota				: Adicionado no array a conta contábil puxando do cadastro de produto
*/
...
Local cContaC	:= ""
	...
	dbSelectArea("SB1")
	SB1->(dbSetOrder(1))
	If SB1->(dbSeek(xFilial("SB1") + Work1->WKCOD_I ))
		cContaC := SB1->B1_CONTA
	EndIf
	...
	EndIf
	If !Empty(cContaC)
		aAdd(aItem,{"D1_CONTA"	,cContaC			,Nil }) && Conta Contábil
	EndIf
