...
User Function ETQLOCAL()
	...
	Processa( {|| PrintETQ() },"imprimindo Etiqueta de Localização..." )   
Return
...
Static Function PrintETQ()
	...
	cQuery += "  BE_LOCAL   >= '" + mv_par01 + "' AND BE_LOCAL  <= '" + mv_par02 + "' AND "
	cQuery += "  BE_LOCALIZ >= '" + mv_par03 + "' AND BE_LOCALIZ<= '" + mv_par04 + "' AND "
	cQuery += "  BE.D_E_L_E_T_ = ' ' "
	cQuery  += "ORDER BY BE_LOCAL+BE_LOCALIZ "

	TcQuery cQuery New Alias &cAliasSBE
	...
	While !(cAliasSBE)->(Eof())
		...
		IncProc("Localização "+Alltrim((cAliasSBE)->BE_LOCAL)+"-"+Alltrim((cAliasSBE)->BE_LOCALIZ))          
		...
		For x:= 1 to mv_par05
			...
			MSCBWrite("^FT263,225^A0N,25,24^FH\^FD"+Substr((cAliasSBE)->BE_DESCRIC,1,30)+"^FS")			
		
	  		MSCBWrite("^BY2,3,100^FT264,150^BCN,,Y,N")
		
//	  			  		MSCBWrite("^BY2,3,51^FT264,96^BCN,,Y,N")
		
			MSCBWrite("^FT263,125^A0N,72,38^FH\^FD"+Alltrim((cAliasSBE)->BE_LOCAL)+Alltrim((cAliasSBE)->BE_LOCALIZ)+"^FS")	
...
Static Function ValidPerg(cPerg)
	...
	aAdd(aRegs, {cPerg, "01", "Armazem de"		,"" ,"" ,"mv_ch1", "C", 02, 0, 0, "G", "", "mv_par01",  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "SBE"}) 
	aAdd(aRegs, {cPerg, "02", "Armazem ate"		,"" ,"" ,"mv_ch2", "C", 02, 0, 0, "G", "", "mv_par02",  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "SBE"}) 
	aAdd(aRegs, {cPerg, "03", "Endereço de"		,"" ,"" ,"mv_ch3", "C", 15, 0, 0, "G", "", "mv_par03",  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "SBE"}) 
	aAdd(aRegs, {cPerg, "04", "Endereço ate"	,"" ,"" ,"mv_ch4", "C", 15, 0, 0, "G", "", "mv_par04",  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "SBE"}) 	
	aAdd(aRegs, {cPerg, "05", "Cópias 	"		,"" ,"" ,"mv_ch5", "N",  3, 0, 0, "G", "", "mv_par05",  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""}) 
