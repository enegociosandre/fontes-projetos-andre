...
±±³Fun‡„o    ³UpdGAC01   ³Autor  ³ Wilson Tedokon       ³ Data ³ 22/03/06 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡„o ³ Atualizacao do dicionario de dados para implementação da   ³±±
±±³          ³ melhoria relacionada ao Configurador de Exemplares         ³±±
...
cMsg += "implementação da melhoria relacionada ao Configurador de Exemplares.   "
...
oMainWnd:cCaption := "Implementando Configurador de Exemplares"
oMainWnd:nLeft := 0
oMainWnd:nTop := 0
oMainWnd:nWidth := 640
...
aAdd(aSX2,{	"JMU",; 							//X2_CHAVE
			cPath,;								//X2_PATH
			"JMU"+cNome,;						//X2_ARQUIVO
			"Configurador Pastas Exemplares",;	//X2_NOME
			"Configurador Pastas Exemplares",;	//X2_NOMESPA
			"Configurador Pastas Exemplares",;	//X2_NOMEENG
			0,;									//X2_DELET
...
aAdd(aSX3,{	"JMU",;								//X3_ARQUIVO
			...
			3,;									//X3_TAMANHO
			0,;									//X3_DECIMAL
			"Tipo Public.",;			    	//X3_TITULO
			"Tipo Public.",;			   		//X3_TITSPA
			"Tipo Public.",;					//X3_TITENG
			"Tipo de Publicacao",;	   		    //X3_DESCRIC
			"Tipo de Publicacao",;   			//X3_DESCSPA
			"Tipo de Publicacao",;				//X3_DESCENG
			"@!",;								//X3_PICTURE
			'ExistCpo("JM2",M->JM0_TPPUBL) .Or. Vazio()',; //X3_VALID
			cUsadoKey,;							//X3_USADO
			"",;								//X3_RELACAO
			"J03",;								//X3_F3
			1,;									//X3_NIVEL
...
aAdd(aSX3,{	"JMU",;								//X3_ARQUIVO
			...
			"Ordem",;	        		   		//X3_TITSPA
			"Ordem",;	        				//X3_TITENG
			"Ordem Campo",;        	   		    //X3_DESCRIC
			"Ordem Campo",;           			//X3_DESCSPA
			"Ordem Campo",;       				//X3_DESCENG
			"99",;								//X3_PICTURE
			"",;                                //X3_VALID
			cUsadoObr,;							//X3_USADO
			"",;								//X3_RELACAO
...
aAdd(aSX3,{	"JMU",;								//X3_ARQUIVO
			...
			"Campo",;	        		   		//X3_TITSPA
			"Campo",;	        				//X3_TITENG
			"Nome do Campo no Dicionario",;	    //X3_DESCRIC
			"Nome do Campo no Dicionario",;  	//X3_DESCSPA
			"Nome do Campo no Dicionario",; 	//X3_DESCENG
			"@!",;								//X3_PICTURE
			"",;                                //X3_VALID
			cUsadoObr,;							//X3_USADO
			"",;								//X3_RELACAO
...
aAdd(aSX3,{	"JMU",;								//X3_ARQUIVO
			...
			0,;									//X3_DECIMAL
			"Pesquisa",;        		    	//X3_TITULO
			"Pesquisa Web",;       		   		//X3_TITSPA
			"Pesquisa Web",;       		   		//X3_TITENG
			"Utilizado Pesquisa Web?",;	   		//X3_DESCRIC
			"Utilizado Pesquisa Web?",;   		//X3_DESCSPA
			"Utilizado Pesquisa Web?",;   		//X3_DESCENG
			"9",;								//X3_PICTURE
			"GACM010_05()",;                    //X3_VALID
			cUsadoObr,;							//X3_USADO
			"2",;								//X3_RELACAO
...
aAdd(aSX3,{	"JM0",;								//X3_ARQUIVO
			...
			"Local Op.",;	       		   		//X3_TITSPA
			"Local Op.",;	    				//X3_TITENG
			"Local Operador Atual",;   		    //X3_DESCRIC
			"Local Operador Atual",;			//X3_DESCSPA
			"Local Operador Atual",;			//X3_DESCENG
			"@!",;								//X3_PICTURE
			"",;                                //X3_VALID
			cUsadoNao,; 						//X3_USADO
			"",;								//X3_RELACAO
...
aAdd(aSX3,{	"JM0",;								//X3_ARQUIVO
			...
			"Cutter",;   	       		   		//X3_TITSPA
			"Cutter",;   	    				//X3_TITENG
			"Cod. Cutter",;          		    //X3_DESCRIC
			"Cod. Cutter",;          			//X3_DESCSPA
			"Cod. Cutter",;         			//X3_DESCENG
			"@!",;								//X3_PICTURE
			"",;                                //X3_VALID
			cUsadoObr,;							//X3_USADO
			"GACA010_15()",;					//X3_RELACAO
			"",;								//X3_F3
			1,;									//X3_NIVEL
			cReservObr,;						//X3_RESERV
			"",;								//X3_CHECK
...
aAdd(aSX3,{	"JM1",;								//X3_ARQUIVO
			...
			"@!",;								//X3_PICTURE
			"M->JM1_LOCACE $ GACVFLOC() .Or. Vazio()",;//X3_VALID
			cUsadoObr,;							//X3_USADO
			"",;								//X3_RELACAO
			"JA3001",;							//X3_F3
			1,;									//X3_NIVEL
...
aAdd(aSX7,{	"JM1_LOCACE",;   		//X7_CAMPO
			"001",;					//X7_SEQUENC
			'POSICIONE("JA3",1,XFILIAL("JA3")+M->JM1_LOCACE,"JA3->JA3_DESLOC")',;					//X7_REGRA
			"JM1_DESLOC",;			//X7_CDOMIN
			"P",;              		//X7_TIPO
			"N",;  					//X7_SEEK
			"",;					//X7_ALIAS
			0,;						//X7_ORDEM
...
aAdd(aSIX,{	"JMU",;   						//INDICE
			"1",;                           //ORDEM
			"JMU_FILIAL+JMU_TPPUBL+JMU_ORDEM",;//CHAVE
			"Tipo de Publicacao + Ordem",;	//DESCRICAO
			"Tipo de Publicacao + Ordem",;	//DESCSPA
			"Tipo de Publicacao + Ordem",;	//DESCENG
			"S",; 							//PROPRI
			"",;  							//F3
			"",;  							//NICKNAME
			"S"}) 							//SHOWPESQ  
...
aAdd(aSIX,{	"JMU",;   						//INDICE
			"2",;                           //ORDEM
			"JMU_FILIAL+JMU_TPPUBL+JMU_CAMPO",;//CHAVE
			"Tipo de Publicacao + Campo",;	//DESCRICAO
			"Tipo de Publicacao + Campo",;	//DESCSPA
			"Tipo de Publicacao + Campo",;	//DESCENG
			"S",; 							//PROPRI
			"",;  							//F3
			"",;  							//NICKNAME
			"S"}) 							//SHOWPESQ  
...
aAltX3_ORDEM	:= {"JM0_TITORI","JM0_TITULO","JM0_SUBTIT", "JM0_COLEC", "JM0_CODESC", "JM0_ASSUNT", "JM0_CLASS",;
                    "JM0_ASDESC","JM0_ANO", "JM0_LOCAL", "JM0_LCDESC", "JM0_EST", "JM0_PAIS", "JM0_PAISDE",;
                    "JM0_IDIOMA", "JM0_IDIDES", "JM0_EMAIL", "JM0_SITE", "JM0_CODSIN", "JM0_SINTES",;
                    "JM0_CODOBS", "JM0_OBS", "JM0_CODRES", "JM0_RESUMO", "JM0_BITMAP"} 
