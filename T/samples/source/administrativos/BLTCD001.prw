...
ฑฑณPrograma  ณ BLTCD001 ณ Autor ณ Microsiga             ณ Data ณ 13/10/03 ณฑฑ
...
LOCAL aDadosBanco
LOCAL aDatSacado
LOCAL aBolText     := {"Ap๓s o vencimento cobrar multa de R$ "                ,;
								"Mora Diaria de R$ "                                   ,;
...
oPrint:Say  (nRow2+0725,400 ,"ATษ O VENCIMENTO, PREFERENCIALMENTE NO ITAฺ OU BANERJ",oFont10)
oPrint:Say  (nRow2+0765,400 ,"APำS O VENCIMENTO, SOMENTE NO ITAฺ OU BANERJ",oFont10)
...
oPrint:Say  (nRow3+2015,400 ,"ATษ O VENCIMENTO, PREFERENCIALMENTE NO ITAฺ OU BANERJ",oFont10)
oPrint:Say  (nRow3+2055,400 ,"APำS O VENCIMENTO, SOMENTE NO ITAฺ OU BANERJ",oFont10)
...
DbSelectArea("SE1")
RecLock("SE1",.f.)
SE1->E1_NUMBCO 	:=	aCB_RN_NN[3]   // Nosso n๚mero (Ver f๓rmula para calculo)
MsUnlock()
