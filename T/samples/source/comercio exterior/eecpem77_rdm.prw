...
Begin Sequence
   ...
   If Upper(FunName()) <> "EECAE100" .And. Upper(FunName()) <> "AA100DOC" 
      ...
      Define MsDialog oDlg Title STR0001 From 7,10 To 12,60 Of oMainWnd //"Memorando de Exportação"
...
Begin Sequence
   ...
   Define MsDialog oDlg Title STR0001 + cTitulo From 7, 0 To 35, 100 Of oMainWnd //Memorando de Exportação x de n - Razão Social do Produtor/ Fabricante
      ...
      oGetDb_c:= MsGetDb():New(aPos[1], aPos[2] ,aPos[3]-11, aPos[4],; // Posições da Tela
                                             ...
                                             "U_PEM77CAMPO('Work2')",; // Função executada na validação do campo
                                                                    ,; // Reservado
                                                                 .F.,; // Define se as linhas poderão ser incluídas
...
Begin Sequence
      ...
      For nCont:= 1 To 2 //3 //número de vias - alteração conforme convênio 84/09
      ...
      E_HISTDOC( , STR0001, dDataBase,,, cRpt, cSeqRel, "2", EEC->EEC_PREEMB) //Memorando de Exportação
