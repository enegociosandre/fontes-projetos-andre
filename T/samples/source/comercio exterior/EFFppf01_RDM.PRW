...
User Function Effppf01()

   M->WG_VL_DEVE:=M->WG_VL_USS+(IF(M->WG_COMAGR $ cSim,M->WG_COM_AG,0))

Return(.T.)

*----------------------------------------------------------------------------*
*                       FIM DO PROGRAMA EFFPPF01.PRW                         *
*----------------------------------------------------------------------------*
