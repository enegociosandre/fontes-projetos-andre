...
AVPRINT oPrn NAME STR0009 //"Commercial Invoice"
   ...
   AVPAGE
        ...
        DO WHILE ! SW7->(EOF()) .AND. SW7->W7_FILIAL == xFilial("SW7") .AND. SW7->W7_HAWB == cHouse
           ...
           nLi_Fim:=nLinha
           PO558VerFim(1)
           oPrn:Say( nLinha,500  ,STR0012+alltrim(trans(SW7->W7_QTDE*W5Peso(),AVSX3("W6_PESO_BR",6)+STR0013)), aFontes:TIMES_NEW_ROMAN_12) //"PESO LIQUIDO: "###" KGS" //FCD 04/07/01  //ASR 27/01/2006 - AVSX3("B1_PESO",6)
           nLinha := nLinha + 50
