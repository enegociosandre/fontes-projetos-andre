...
Begin Sequence
   ...
   Define MsDialog oDlg Title cTitRpt From 1,1 To 136,360 Of oMainWnd Pixel //136,264 320
      
      AvBorda(oDlg,.f.)     
            
      @  22,07 SAY STR0011 Pixel //"Tipo Relatório:"
      @  20,45 COMBOBOX cCombo ITEMS aCombo SIZE 80,8 PIXEL

      @  37,07 Say STR0012 Pixel //"Data Inicial:"
      @  35,45 MsGet dDtIni Size 40,8  Pixel
      
      @  52,07 Say STR0013 Pixel //"Data Final:"
      @  50,45 MsGet dDtFim Size 40,8  Pixel 
