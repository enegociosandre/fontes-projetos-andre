...
IF cPaisLoc == "BRA"
   IF cExecute == "BOTAO" 
      @ 04,050 BUTTON STR0259 SIZE 37,11 ACTION (IF(DIGerou(),Processa({|| DI154PRETXT()},STR0031),)) // EXPORTA
      nOpca:=0
   ENDIF
   RETURN .T.
ENDIF
...
LOCAL aEstrutura:={{"WKCOD_I"   ,"C",30,00},;
                   {"WKQUALIF"  ,"C",03,00},;
				   {"WKTEC"     ,"C",10,00},;
                   {"WKQUAL_NCM","C",03,00},;
                   {"WKQTDE"    ,"N",15,04},;
