...
Else
	If ::cTpNF == "E"
		...
		Do While !SD1->(Eof()) .and. SD1->(D1_FILIAL+D1_DOC+D1_SERIE+D1_CLIENTE+D1_LOJA) == xFilial("SD1")+cSeek
...
oSay2      := TSay():New( 040,012,{||"Cliente"},oGrp1,,,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,032,008)
